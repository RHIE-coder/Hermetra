...
`.claude/` holds no workflow: the previous harness's skills and agents
(`/intake`, `/sprint`, `testwriter`, ...) were deleted on 2026-07-29. What is
left is the hooks, the ledger and the check scripts above.
